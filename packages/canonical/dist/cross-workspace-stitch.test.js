...
function makeCoreFileSym(id, absPath, relPath, withinWsPath) {
    return {
        id,
        kind: 'file',
...
describe('stitchCrossWorkspaceEdges', () => {
    ...
    it('rewrites dist/.d.ts external reference to internal file-symbol', () => {
        ...
        const coreFileSym = makeCoreFileSym(CORE_FILE_ERRORS, '/repo/packages/core/src/errors.ts', 'packages/core/src/errors.ts', 'src/errors.ts');
        const cliFileSym = {
            id: CLI_FILE_DOCTOR,
            kind: 'file',
            name: 'doctor.ts',
    ...
    it('stitches multiple distinct symbols in one pass', () => {
        const coreErrorsSym = makeCoreFileSym(CORE_FILE_ERRORS, '/repo/packages/core/src/errors.ts', 'packages/core/src/errors.ts', 'src/errors.ts');
        const coreIndexSym = makeCoreFileSym(CORE_FILE_INDEX, '/repo/packages/core/src/index.ts', 'packages/core/src/index.ts', 'src/index.ts');
...
//# sourceMappingURL=cross-workspace-stitch.test.js.map